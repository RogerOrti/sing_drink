...
<div class="icono-chat">
    <Button @click="toggleChat" class="mb-4" :style="{ background: 'none', border: 'none' }">
        <svg fill="#EEC765" height="55px" width="70px" version="1.1" id="Layer_1"
            ...
            <g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round" stroke="#EEC765" stroke-width="15.640102000000002">
                <g>
                    <path
  ...
  <div v-if="isChatOpen" class="chat-window">
    <div class="chat-content">
      <div class="chat-sidebar">
        ...
        <ul class="chat-list">
          <li v-for="chat in filteredChats" :key="chat.id" @click="fetchMessages(chat.id_propietari, chat.id_music)">
            <div class="avatar">
      ...
      <div class="chat-messages">
        <div v-if="messages.length" class="messages-container">
          <div v-for="message in messages" :key="message.id" class="message-bubble" :class="{'from-user': message.propietari.id === currentUserId}">
