<template>
    <div class="coleccioMusics">
        <div class="cardsLocals" v-for="music in musics" :key="music.id_user">
            <div class="cardMusics">
                <img
                    :src="music.multimedia_music[0].ruta"
                    class="cardMusics"
                    alt=""
                />
                ...
                <div>
                    ...
                    <a
                        :href="'music/' + music.id_user"
                        class="btn btnMusics btn-primary"
                        >Saber més</a
                    >
                    <img
                        class="play card-img-top"
                        :src="'image/erfan/logoPlay2.webp'"
                        alt=""
                    />
                </div>
            </div>
    ...
    <div
        class="pagination d-flex justify-content-center align-items-center my-4"
    >
        <button
...
export default {
    ...
    methods: {
        GetMusic(page = 1) {
            axios
                .get("musics/paginado", { params: { page } })
                .then((response) => {
